        ...
        <div className={styles.footerGrid}>
          ...
          <div className={`${styles.footerColumn} ${styles.footerInfo}`}>
            <div className={styles.footerLogo}>
              <Link
                href="/#home"
                aria-label={`Ir para a página inicial de ${COMPANY_NAME}`}
              >
                <Image
          ...
          <div className={`${styles.footerColumn} ${styles.footerSocial}`}>
            ...
            <div className={styles.newsletterFeedback}>
              {newsletterStatus === 'success' && (
                <p className={styles.successMessage}>{newsletterMessage}</p>
              )}
              {newsletterStatus === 'error' && (
                <p className={styles.errorMessage}>{newsletterMessage}</p>
              )}
            </div>
          </div>
        </div>
            ...
            <a
              ...
              onClick={() =>
                trackEvent('outbound_click', {
                  location: 'footer',
                  link_type: 'developer_credit',
                  destination: DEVELOPER_URL,
                })
              }
            >
              {DEVELOPER_NAME}

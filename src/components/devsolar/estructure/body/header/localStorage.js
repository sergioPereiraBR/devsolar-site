...
const leadsData = [
  {
    id: 1,
    nome: 'Luiz',
    telefone: '21992955426',
    consumo: 'Acima de 1.000',
    data: '11/01/2026',
    notas: 'Interessado em 10 placas.',
  },
  // ... outros leads
];
  ...
  return (
    ...
    >
      ...
      >
        <p>
          <strong>Nome:</strong>{' '}
          <span style={{ fontSize: '24px' }}>{leadAtual.nome}</span>
        </p>
        <p>
          <strong>⚡ Consumo:</strong> {leadAtual.consumo}
        </p>
        <p>
          <strong>🗓️ Agendamento:</strong> {leadAtual.data}
        </p>
        <p>
          <strong>📝 Notas:</strong> {leadAtual.notas}
        </p>
      ...
      >
        ...
        <button
          onClick={() =>
            setCurrentIndex((prev) => Math.min(leadsData.length - 1, prev + 1))
          }
          style={{ padding: '15px' }}
        >
          Próximo Lead

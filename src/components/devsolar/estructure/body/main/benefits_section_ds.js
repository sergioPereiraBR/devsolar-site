...
function BenefitsSectionDS() {
  ...
  const handleShowDetailView = (detailData) => {
    trackEvent('modal_open', {
      location: 'benefits_section',
      modal_name: 'benefit_detail',
      detail_title: detailData.detailTitle,
    });
  ...
  return (
    <>
      <section
        id="beneficios"
        className={`${styles.sectionBenefits} section`}
        ...
        <div className="container">
          <div className="mb-5 text-center">
            ...
            <p className={`${styles.sectionSubtitle} lead`}>
              Descubra os benefícios que milhares de clientes já aproveitam
            </p>
          </div>

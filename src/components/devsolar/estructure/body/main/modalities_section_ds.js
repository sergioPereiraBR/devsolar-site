...
const modalitiesData = [
    ...
    },
    {
        ...
        modalText: 
            `Esta modalidade permite que múltiplos consumidores compartilhem os benefícios de uma mesma usina solar, mesmo estando em locais diferentes.<br /><br />
            <strong>Pontos-chave:</strong><br /><br />
    ...
    },
    {
        ...
        modalText: 
            `Esta modalidade permite a comercialização de créditos de energia solar para terceiros, criando um modelo de negócio específico.<br /><br />
            <strong>Pontos-chave:</strong><br /><br />
                            ...
                            <Col key={modality.id} md={6} lg={4}>
                                <Card className={`${styles.modalityCard} h-100`}>
                                    <div className={styles.cardHeader}>
                                        <FaIcon iconClass={modality.iconClass} className={styles.cardIcon} />

...
function ModalitiesSectionDS() {
  ...
  const handleShowModal = (modalityData) => {
    trackEvent('modal_open', {
      location: 'modalities_section',
      modal_name: 'modality_detail',
      modality_id: modalityData.id,
      modality_title: modalityData.title,
    });
  ...
  const handleCloseModal = () => {
    trackEvent('modal_close', {
      location: 'modalities_section',
      modal_name: 'modality_detail',
      modality_id: selectedModalContent?.id,
    });
    setShowModal(false);
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body className={styles.modalBodyContentStacked}>
          {' '}
          {/* Nova classe CSS */}

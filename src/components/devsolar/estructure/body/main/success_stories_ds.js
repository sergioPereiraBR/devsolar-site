...
const successStories = [
    ...
    { id: 1, title: 'Condomínio Lilases', thumbnail: CondLilases, preview: './videos/depcon01.mp4', type: "Condominial", impact: "Economia imediata", resume: "Investimento inteligente com a Dev Solar! Gasto de R$ 6.000 virou economia, pagando o financiamento e permitindo outras melhorias.", description: "Descrição detalhada: Investir em energia solar com a DEV Solar foi a decisão financeira mais inteligente que tomamos recentemente. Convertemos um gasto de mais de R$ 6.000,00/mês num financiamento de R$ 4.500,00 durante 3 ano e depois disso a geração própria de energia beneficiará ainda mais o condomínio. O sistema de energia solar já se tornou um investimento que se paga com a própria economia gerada, e ainda conseguimos direcionar recursos para outras melhorias! O retorno é mais rápido do que o previsto. A instalação foi ágil e a equipe demonstrou total profissionalismo." },
    { id: 2, title: 'Casa da Fernanda', thumbnail: CasaFernanda, preview: './videos/depcon02.mp4', type: "Residencial", impact: "Bom Atendimento e Valor Ideal", resume: "Agora produzimos nossa própria energia e reduzimos custos com a conta de luz. Fomos bem atendidos e estamos satisfeitos com o serviço.", description: "Descrição detalhada: Devido o atendimento proativo e esclarecedor todas as dúvidas foram respondidas prontamente, juntamente com a flexibilidade na negociação chegamos a um valor ideal que viabilizou a instalação do sistema de energia solar, o qual se converte em benefícios para casa e toda família." },
    { id: 3, title: 'Casa do Osmar', thumbnail: CasaOsmar, preview: './videos/depcon03.mp4', type: "Residencial", impact: "Confiança e Excelente Qualidade", resume: "A instalação do nosso sistema solar foi feita com profissionais de excelente qualidade até a entrega com a ligação no rede pública de energia.", description: "A instalação do nosso sistema solar foi feita com profissionais de excelente qualidade, onde desde a negociação já se demostrou terem confiança e compromisso com o que fazem até a entrega final na integração com o serviço público de energia elétrica." },
    { id: 4, title: 'Condomínio Lilases', thumbnail: CondLilases, preview: './videos/depcon01.mp4', type: "Condominial", impact: "Economia imediata", resume: "Investimento inteligente com a Dev Solar! Gasto de R$ 6.000 virou economia, pagando o financiamento e permitindo outras melhorias.", description: "Descrição detalhada: Investir em energia solar com a DEV Solar foi a decisão financeira mais inteligente que tomamos recentemente. Convertemos um gasto de mais de R$ 6.000,00/mês num financiamento de R$ 4.500,00 durante 3 ano e depois disso a geração própria de energia beneficiará ainda mais o condomínio. O sistema de energia solar já se tornou um investimento que se paga com a própria economia gerada, e ainda conseguimos direcionar recursos para outras melhorias! O retorno é mais rápido do que o previsto. A instalação foi ágil e a equipe demonstrou total profissionalismo." },
    { id: 5, title: 'Casa da Fernanda', thumbnail: CasaFernanda, preview: './videos/depcon02.mp4', type: "Residencial", impact: "Bom Atendimento e Valor Ideal", resume: "Agora produzimos nossa própria energia e reduzimos custos com a conta de luz. Fomos bem atendidos e estamos satisfeitos com o serviço.", description: "Descrição detalhada: Devido o atendimento proativo e esclarecedor todas as dúvidas foram respondidas prontamente, juntamente com a flexibilidade na negociação chegamos a um valor ideal que viabilizou a instalação do sistema de energia solar, o qual se converte em benefícios para casa e toda família." },
    { id: 6, title: 'Casa do Osmar', thumbnail: CasaOsmar, preview: './videos/depcon03.mp4', type: "Residencial", impact: "Confiança e Excelente Qualidade", resume: "A instalação do nosso sistema solar foi feita com profissionais de excelente qualidade até a entrega com a ligação no rede pública de energia.", description: "A instalação do nosso sistema solar foi feita com profissionais de excelente qualidade, onde desde a negociação já se demostrou terem confiança e compromisso com o que fazem até a entrega final na integração com o serviço público de energia elétrica." },
];
                                ...
                                <SwiperSlide key={story.id} className={styles.swiperSlide}>
                                    ...
                                    <Card className={styles.storyCard}>
                                        ...
                                        <Card.Body style={{ backgroundColor: 'var(--branco)' }}>
                                            <Card.Title className={styles.cardTitle}><h3>{story.title}</h3></Card.Title>
                                            {/* Descrição curta pode ir aqui ou usar CSS para limitar a principal '#F8F9FA' */}
                                            <h4 className={styles.cardShortDescription}>{story.resume}</h4>

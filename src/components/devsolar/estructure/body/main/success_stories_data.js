...
export const successStories = [
  {
    ...
    alt: 'Foto do Condomínio Lilases',
    preview: '/videos/depcon01.mp4',
    type: 'Condominial',
    power: 'Sistema de 50kWp',
    installationDate: 'Instalado em 2022',
    energyProduction: 'Produção de 70.000 kWh/ano',
    economicImpact: 'Economia de R$ 6.000/mês',
  ...
  },
  {
    ...
    alt: 'Foto da Casa da Fernanda',
    preview: '/videos/depcon02.mp4',
    type: 'Residencial',
    power: 'Sistema de 10kWp',
    installationDate: 'Instalado em 2023',
    energyProduction: 'Produção de 12.000 kWh/ano',
    economicImpact: 'Economia de R$ 800/mês',
  ...
  },
  {
    ...
    title: 'Casa do Osmar',
    thumbnail: CasaOsmar,
    alt: 'Foto da Casa do Osmar',
    preview: '/videos/depcon03.mp4',
    type: 'Residencial',
    power: 'Sistema de 10kWp',
    installationDate: 'Instalado em 2023',
    energyProduction: 'Produção de 12.000 kWh/ano',
    economicImpact: 'Economia de R$ 900/mês',

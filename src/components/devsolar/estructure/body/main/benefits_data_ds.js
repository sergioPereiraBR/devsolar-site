    ...
    categories: [
      {
        ...
        title: 'Residência',
        description:
          'Reduza drasticamente ou elimine sua conta de luz já no primeiro mês.',
        detail: createCategoryDetail(
          'ec-res',
          'Residência - Economia Imediata',
          'Elimine sua conta de luz já no primeiro mês após a instalação.',
...
Visitei o site com interesse em reduzir custos com energia elétrica na residência e quero falar com especialista.`,
      ...
      },
      {
        ...
        title: 'Condomínio',
        description:
          'Diminua significativamente a taxa condominial para todos os moradores.',
        detail: createCategoryDetail(
          'ec-con',
          'Condomínio - Economia Imediata',
          'Diminua significativamente a taxa condominial para todos os moradores.',
...
Visitei o site com interesse em reduzir custos com energia elétrica no condomínio e quero falar com especialista.`,
      ...
      },
      {
        ...
        title: 'Empresa',
        description:
          'Reduza seus custos operacionais, aumentando a margem de lucro.',
        detail: createCategoryDetail(
          'ec-emp',
          'Empresa - Economia Imediata',
          'Aumente sua margem de lucro e a competitividade do seu negócio.',
    ...
    categories: [
      {
        ...
        title: 'Residência',
        description:
          'Contribua ativamente para um futuro mais verde, reduzindo sua pegada de carbono.',
        detail: createCategoryDetail(
          'sus-res',
          'Residência - Sustentabilidade',
          'Contribua ativamente para um futuro mais verde',
...
Visitei o site com interesse em reduzir a pegada de carbono, em energia limpa e renovável na residência e quero falar com especialista.`,
      ...
      },
      {
        ...
        title: 'Condomínio',
        description:
          'Demonstre o compromisso com a sustentabilidade em larga escala.',
        detail: createCategoryDetail(
          'sus-con',
          'Condomínio - Sustentabilidade',
          'Compromisso com sustentabilidade em larga escala',
...
Visitei o site com interesse em reduzir a pegada de carbono, em energia limpa e renovável no condomínio e quero falar com especialista.`,
      ...
      },
      {
        ...
        title: 'Empresa',
        description:
          'Fortaleça a imagem da sua marca como ecologicamente responsável.',
        detail: createCategoryDetail(
          'sus-emp',
          'Empresa - Sustentabilidade',
          'Fortaleça sua imagem como empresa ecologicamente responsável',
    ...
    categories: [
      {
        ...
        title: 'Residência',
        description:
          'Aumente o valor de mercado do seu imóvel, tornando-o mais atrativo.',
        detail: createCategoryDetail(
          'val-res',
          'Residência - Valorização Imobiliária',
          'Aumente o valor de mercado do seu imóvel',
...
Visitei o site com interesse na valorização do imóvel residencial e quero falar com especialista.`,
      ...
      },
      {
        ...
        detail: createCategoryDetail(
          'val-con',
          'Condomínio - Valorização Imobiliária',
          'Valorize todas as unidades do condomínio',
...
Visitei o site com interesse na valorização dos imóveis do condomínio e quero falar com especialista.`,
      ...
      },
      {
        ...
        title: 'Empresa',
        description:
          'Seu imóvel comercial se torna um ativo mais valioso e competitivo.',
        detail: createCategoryDetail(
          'val-emp',
          'Empresa - Valorização Imobiliária',
          'Seu imóvel comercial com energia solar',
    ...
    categories: [
      {
        ...
        title: 'Residência',
        description:
          'Sistemas requerem pouca manutenção, geralmente apenas limpezas periódicas.',
        detail: createCategoryDetail(
          'man-res',
          'Residência - Baixa Manutenção',
          'Sistemas solares de baixa manutenção',
...
Visitei o site com interesse na baixa manutenção do sistema de energia solar na residência e quero falar com especialista.`,
      ...
      },
      {
        ...
        title: 'Condomínio',
        description:
          'Custos e trabalho de conservação mínimos, otimizando recursos a longo prazo.',
        detail: createCategoryDetail(
          'man-con',
          'Condomínio - Baixa Manutenção',
          'Sistemas duráveis e econômicos',
          ...
          [
            ...
            },
            {
              ...
              link: 'https://energiasirius.com/manutencao-energia-solar/',
            }, // Nota: Link repetido na fonte original
          ],
          [
...
Visitei o site com interesse na baixa manutenção do sistema de energia solar no condomínio e quero falar com especialista.`,
      ...
      },
      {
        ...
        title: 'Empresa',
        description:
          'Sistemas projetados para durar, permitindo foco no core business.',
        detail: createCategoryDetail(
          'man-emp',
          'Empresa - Baixa Manutenção',
    ...
    categories: [
      {
        ...
        title: 'Residência',
        description:
          'Proteja seu orçamento familiar contra elevações nas tarifas.',
        detail: createCategoryDetail(
          'pro-res',
          'Residência - Proteção contra Aumentos',
          'Proteção contra aumentos na conta de luz',
...
Visitei o site com interesse na proteção contra aumentos no custo da energia consumida na residência e quero falar com especialista.`,
      ...
      },
      {
        ...
        detail: createCategoryDetail(
          'pro-con',
          'Condomínio - Proteção contra Aumentos',
          'Redução de vulnerabilidade tarifária',
...
Visitei o site com interesse na proteção contra aumentos no custo da energia consumida no condomínio e quero falar com especialista.`,
      ...
      },
      {
        ...
        title: 'Empresa',
        description:
          'Minimize o impacto das flutuações de custos de energia no seu negócio.',
        detail: createCategoryDetail(
          'pro-emp',
          'Empresa - Proteção contra Aumentos',
    ...
    categories: [
      {
        ...
        title: 'Residência',
        description:
          'Aproveite diversas opções com condições facilitadas e taxas atrativas.',
        detail: createCategoryDetail(
          'fin-res',
          'Residência - Financiamento Facilitado',
          'Financiamento facilitado para energia solar',
...
Visitei o site com interesse no financiamento facilitado para residência e quero falar com especialista.`,
      ...
      },
      {
        ...
        detail: createCategoryDetail(
          'fin-con',
          'Condomínio - Financiamento Facilitado',
          'Financiamento coletivo e sustentável',
...
Visitei o site com interesse no financiamento facilitado para condomínio e quero falar com especialista.`,
      ...
      },
      {
        ...
        title: 'Empresa',
        description:
          'Descubra linhas de financiamento e incentivos fiscais disponíveis.',
        detail: createCategoryDetail(
          'fin-emp',
          'Empresa - Financiamento Facilitado',

...
const ContactSectionDS = ({ textClassButton, textMessage, textTag }) => {
  ...
  const WHATSAPP_BASE_MESSAGE =
    'Olá! Solicito falar com um especialista e obter mais informações.\n\n';
  // --- Fim dos Dados ---
  ...
  const handleSubmit = (event) => {
    ...
    const finalMessage =
      formData.message ||
      textMessage ||
      'Olá, quero falar com um especialista.'; // Garante uma mensagem
    const messageBody =
  ...
  const modalStyles = {
    modalContent: {
      backgroundImage: `url('${moduleBackgroundImage.src}')`,
        ...
        <div style={modalStyles.modalContent}>
          <Modal.Header style={modalStyles.modalHeader}>
            <Modal.Title style={modalStyles.modalTitle}>
              Solicito falar com Especialista:
            </Modal.Title>
          ...
          <Modal.Body style={modalStyles.modalBody}>
            <Form onSubmit={handleSubmit}>
              <Form.Group className="mb-3">
                <Form.Label htmlFor="firstName" style={modalStyles.formLabel}>
                  Nome
                </Form.Label>
                <Form.Control
                  ref={firstNameRef}
              ...
              {formData.roofType === 'Outro' && (
                <Form.Group className="mb-3">
                  <Form.Label htmlFor="otherRoof" style={modalStyles.formLabel}>
                    Especifique
                  </Form.Label>
                  <Form.Control
                    type="text"
              ...
              <div
                className="d-grid"
                style={{ marginTop: 50, marginBottom: 340 }}
              >
                <Button
                  variant="primary"
                  type="submit"
                ...
                {whatsAppStatus === 'failed_fallback_web' && (
                  <div style={{ marginTop: 20, color: 'yellow' }}>
                    {' '}
                    {/* Cor de aviso */}
                    <p>
                      Não foi possível abrir o app WhatsApp automaticamente.
                    </p>
                    <p>
                      <a
                      ...
                      >
                        Clique aqui para tentar enviar pela versão Web do
                        WhatsApp
                      </a>
                    </p>
                  </div>

    ...
    <div className="obfuscate">
      <div className="relative flex flex-col items-center justify-center py-16">
        <div className="mx-auto">
          ...
          >
            <div className="focus:outline-hidden dark:bg-white/5 dark:ring-white/10 inline-flex max-w-full items-center gap-3 rounded-full px-2.5 py-0.5 pl-0.5 pr-3 font-medium text-gray-900 shadow-lg shadow-blue-400/20 ring-1 ring-black/5 filter backdrop-blur-[1px] transition-colors hover:bg-blue-500/[2.5%] dark:text-gray-50 sm:text-sm">
